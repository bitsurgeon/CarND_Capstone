...
SSD_GRAPH_FILE_SIMULATOR = './model/sim_ssd_mobilenet_v2_coco_2018_03_29_28930_v1_4/frozen_inference_graph.pb'
...
if __name__ == '__main__':
    ...
    # site
    print TLClassifier(True).get_classification(Image.open('./model/rosbag_sample.jpg'))

    # sim
    print TLClassifier(False).get_classification(Image.open('./model/sim_sample.png'))
